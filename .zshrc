...
# ZSH syntax highlighting based on OS (if installed).
...
if [[ -n "$SYNTAX_HIGHLIGHTING_PATH" && -f "$SYNTAX_HIGHLIGHTING_PATH" ]]; then
    source "$SYNTAX_HIGHLIGHTING_PATH"
else
    echo "zsh-syntax-highlighting not found at $SYNTAX_HIGHLIGHTING_PATH."
fi